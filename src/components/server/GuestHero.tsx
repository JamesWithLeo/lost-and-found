...
export default function GuestHero() {
  return (
    <section className="flex h-dvh max-h-[920px] w-full max-w-[1440px] flex-col items-center justify-center bg-gradient-to-r from-[#4c96d7] to-white">
      <section className="grid h-[80%] w-[85%] grid-cols-1 grid-rows-2 bg-white">
        ...
        <div className="flex h-full w-full items-end justify-center">
          <h1
            className={`${inconsolata.className} border bg-gradient-to-tr from-black via-[#4c96d7] to-black bg-clip-text text-[9rem] font-black text-transparent`}
          >
            Lost & Found
          </h1>
        </div>
