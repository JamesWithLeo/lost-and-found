...
export default async function Page() {
  ...
  const postFoundItemsAction = postFoundItems.bind(null, session?.user.id);
  return (
    <Form
    ...
    >
      ...
      <div className="flex flex-col items-end justify-center">
        <button
          className="bg-primary flex cursor-pointer items-center gap-2 rounded-full bg-gray-100 px-4 py-1 text-white"
          type="submit"
        >
          <svg
